...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../assets/images/icons.png" alt="AdminLTELogo" height="350" width="350">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../assets/images/icons1.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="#" target="_blank">Indra Tidke</a>.</strong>
    All rights reserved.
